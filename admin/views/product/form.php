...
<div class="panel-body">
    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=product&amp;action=edit"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <input name="createdate" type="date" value="<?php echo $product ? $product['Createdate'] : ''; ?>"
                       class="form-control" id="createdate"  min="2016-01-02" max="2020-12-31"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="totalview" type="hidden" value="<?php echo $product ? $product['TotalView'] : ''; ?>"
                       class="form-control" id="totalview" />
            </div>
        </div>
